            ...
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="main-heading" style="color: white;">
                        <h1>{{ $page->title ?? 'Job Application' }}</h1>
                        <div class="pages-intro" style="color: white;">
                            <a href="{{ url('/') }}" style="color: white;">Home</a>
                            <span><i class="fa-regular fa-angle-right"></i></span>
                            <p style="display: inline;">Careers</p>
                            <span><i class="fa-regular fa-angle-right"></i></span>
                            <p style="display: inline;">{{ $page->title ?? 'Job Application' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="job-details-area right-padding">
                        <div class="tags-area">
                            <ul>
                                ...
                                <li class="add-icon"><span class="icon"><img
                                    ...
                                    Posted 3 months ago</li>
                                <li class="add-icon"><span class="icon"><img
                                            src="{{ asset('assets/img/icons/job-details-tag-icon3.svg') }}" alt=""></span>
                                    $1700 / Month</li>
                            </ul>
                        </div>
                        ...
                        <div class="job-owner">
                            <div class="image">
                                <img src="{{ asset('assets/img/job-post/job-post-image2.png') }}" alt="">
                            </div>
                            <div class="text">
                                <h4>Creative Hive</h4>
                            </div>
                        ...
                        <article>
                            <div class="job-single-post">
                                ...
                                <div class="heading1">
                                    ...
                                    <p>Creative Hive is excited to announce an opening for a Social Media Specialist...</p>
                                </div>
                            </div>
                        </article>
                        ...
                        <article>
                            <div class="job-single-post">
                                <div class="heading1">
                                    ...
                                    <p>Manage and grow social media platforms...</p>
                                    <ul class="job-detials-list">
                                        <li><i class="fa-solid fa-check"></i> Implement strategies to boost brand awareness
                                        </li>
                                        <li><i class="fa-solid fa-check"></i> Manage social accounts</li>
                                        <li><i class="fa-solid fa-check"></i> Schedule compelling posts</li>
                                        <li><i class="fa-solid fa-check"></i> Collaborate with creative teams</li>
                                        <li><i class="fa-solid fa-check"></i> Stay updated on trends</li>
                                    </ul>
                                </div>
                            </div>
                        </article>
                        ...
                        <article>
                            <div class="job-single-post">
                                <div class="heading1">
                                    ...
                                    <p>We seek candidates with:</p>
                                    <ul class="job-detials-list">
                                        <li><i class="fa-solid fa-check"></i> Proven social media experience</li>
                                        <li><i class="fa-solid fa-check"></i> Strong communication skills</li>
                                        <li><i class="fa-solid fa-check"></i> Familiar with social tools</li>
                                        <li><i class="fa-solid fa-check"></i> Bachelor’s degree preferred</li>
                                    </ul>
                                </div>
                            </div>
                        </article>
                        ...
                        <article>
                            <div class="job-single-post">
                                <div class="heading1">
                                    ...
                                    <p>Join us in the heart of digital innovation.</p>
                                    <ul class="job-detials-list">
                                        <li><i class="fa-solid fa-check"></i> Flexible work schedule</li>
                                        <li><i class="fa-solid fa-check"></i> Creative environment</li>
                                        <li><i class="fa-solid fa-check"></i> Career growth</li>
                                    </ul>
                                </div>
                            </div>
                        </article>
