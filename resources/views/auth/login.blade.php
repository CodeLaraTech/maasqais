            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- Password -->
                        <div class="input-group input-group-outline mt-3 @if(old('password')) is-filled @endif">
                        ...
                        <div class="form-check form-switch d-flex align-items-center my-3">
                            ...
                            <label class="form-check-label mb-0 ms-2" for="remember_me">Remember me</label>
                        </div>
