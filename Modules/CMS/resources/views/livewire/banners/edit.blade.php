                ...
                <div class="card my-4">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white mx-3"><strong>Edit Banner</strong></h6>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="update" class="border rounded p-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border rounded p-3" wire:model="slug"
                                    placeholder="Auto-generated or edit manually">
                                <small class="text-muted">This will be auto-generated from the name unless edited manually.</small>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            @elseif(isset($item['image_path']))
                                                <img src="{{ asset('storage/' . $item['image_path']) }}" alt="preview"
                            ...
                            <!-- Add Item Button -->
                            <div class="mb-3">
                                <button type="button" class="btn btn-outline-primary" wire:click="addItem">+ Add Banner Item</button>
                            </div>
