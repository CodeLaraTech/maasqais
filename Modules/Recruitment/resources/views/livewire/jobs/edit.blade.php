<div class="container-fluid py-4">
    <div class="row">
        <div class="col-10 m-auto">
            <h3 class="mt-3 mb-0 text-center">Edit Job</h3>
            <p class="lead font-weight-normal opacity-8 mb-3 text-center">Update the details for this job posting.</p>
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-group input-group-outline">
                                    ...
                                    <input type="text" class="form-control datetimepicker" wire:model.defer="job.expiry_at">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3 d-none">
                                        <div class="input-group input-group-outline">
                                            ...
                                            <input type="number" step="0.01" class="form-control" wire:model.defer="job.transportation_allowance">
                                        </div>
                                        @error('job.transportation_allowance') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-md-6 mb-3 d-none">
                                        <div class="input-group input-group-outline">
                                            <label>House Rent Allowance</label>
                                            <input type="number" step="0.01" class="form-control" wire:model.defer="job.house_rent_allowance">
                                        </div>
                                        @error('job.house_rent_allowance') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-md-6 mb-3 d-none">
                                        <div class="input-group input-group-outline">
                                        ...
                                        @error('job.other_allowances') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-md-6 mb-3 d-none">
                                        <div class="input-group input-group-outline">
