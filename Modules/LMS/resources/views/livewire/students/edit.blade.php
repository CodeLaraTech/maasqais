<div class="container-fluid py-4" x-data>
    <div class="row">
        <div class="col-10 m-auto">
            <h3 class="mt-3 mb-0 text-center">Edit Student</h3>
            <p class="lead font-weight-normal opacity-8 mb-3 text-center">Update the details for this student.</p>
                    ...
                    <form wire:submit.prevent="update" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5 mb-3">
                                ...
                                <div class="mt-3">
                                    @if ($student['photo'] instanceof \Livewire\TemporaryUploadedFile)
                                        <p>New Photo Preview:</p>
                                        <img src="{{ $student['photo']->temporaryUrl() }}" width="150" class="rounded">
                                    @elseif ($student['photo'])
                                        <p>Existing Photo:</p>
                                        <img src="{{ asset('storage/' . $student['photo']) }}" width="150" class="rounded">
                                    @endif
                                </div>
                            </div>
